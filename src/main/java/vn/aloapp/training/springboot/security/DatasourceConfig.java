...
public class DatasourceConfig {
	...
	private HikariConfig initHikariPoolingConfig(String poolName) {
		...
		hikariConfig.setJdbcUrl("jdbc:mysql://localhost:3306/retail_traditional?characterEncoding=UTF-8&useLegacyDatetimeCode=false&noAccessToProcedureBodies=true&serverTimezone=Asia/Bangkok");
